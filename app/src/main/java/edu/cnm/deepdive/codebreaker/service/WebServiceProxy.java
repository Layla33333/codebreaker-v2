...
public interface WebServiceProxy {
  ...
  @GET("users/ranked")
  Single<List<RankedUser>> getRankings(@Query("length")int length, @Query("poolSize") int poolSize, @Query("order") String  order, @Header("Authorization") String bearerToken);
