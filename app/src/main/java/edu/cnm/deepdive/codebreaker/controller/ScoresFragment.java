...
public class ScoresFragment extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    binding.codeLengthDisplay.setText(String.valueOf(resources.getInteger(R.integer.code_length_pref_default)));
    binding.poolSizeDisplay.setText(String.valueOf(resources.getInteger(R.integer.pool_size_pref_default)));
